...
export type AgentMessage =
  ...
  | { type: 'tool-call'; toolName: string; args: Record<string, unknown>; callId: ToolCallId; title?: string | null; description?: string | null }
...
/** Agent identifier */
export type AgentId = 'claude' | 'codex' | 'gemini' | 'opencode' | 'openclaw' | 'agy' | 'kimi' | 'traex' | 'claude-acp' | 'codex-acp';
