...
export const agentKeys = ['claude', 'codex', 'gemini', 'openclaw', 'agy', 'kimi', 'traex'] as const;
...
export const AgentDefaultOverridesSchema = z.object({
    ...
    kimi: AgentDefaultOverrideSchema.optional(),
    traex: AgentDefaultOverrideSchema.optional(),
}).passthrough().default({});
...
const codeAgentDefaults: Record<AgentKey, AgentDefaultConfig> = {
    ...
    kimi: { permissionMode: 'default', modelMode: 'default', effortLevel: null },
    traex: { permissionMode: 'default', modelMode: 'default', effortLevel: null },
};
...
export function normalizeAgentKey(flavor: string | null | undefined): AgentKey {
    if (flavor === 'codex' || flavor === 'gemini' || flavor === 'openclaw' || flavor === 'agy' || flavor === 'kimi' || flavor === 'traex') {
        return flavor;
    }
    return 'claude';
}
