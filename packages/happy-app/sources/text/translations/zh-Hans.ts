...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        sessionName: '会话名称',
        sessionNameDefault: '未命名会话',
        sessionNamePrompt: '输入自定义会话名称。留空可恢复默认名称。',
        sessionNamePlaceholder: '例如：发布前检查',
        ...
        traexSessionId: 'TraeX 会话 ID',
        traexSessionIdCopied: 'TraeX 会话 ID 已复制到剪贴板',
        aiProvider: 'AI 提供商',
        failedToCopyClaudeCodeSessionId: '复制 Claude Code 会话 ID 失败',
        failedToCopyCodexThreadId: '复制 Codex 线程 ID 失败',
        failedToCopyKimiSessionId: '复制 Kimi 会话 ID 失败',
        failedToCopyTraexSessionId: '复制 TraeX 会话 ID 失败',
