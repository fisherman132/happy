...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        sessionNameDefault: 'Unnamed session',
        sessionNamePrompt: 'Enter a custom session name. Leave it blank to restore the default name.',
        sessionNamePlaceholder: 'e.g. Release check',
        ...
        traexSessionId: 'TraeX Session ID',
        traexSessionIdCopied: 'TraeX Session ID copied to clipboard',
        ...
        failedToCopyKimiSessionId: 'Failed to copy Kimi Session ID',
        failedToCopyTraexSessionId: 'Failed to copy TraeX Session ID',
        ...
        resumeSessionMissingBackendId: 'This session does not have a resumable Claude, Codex, Kimi or TraeX identifier.',
